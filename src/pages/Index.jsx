    ...
    <div className="min-h-screen bg-white">
      <main className="flex flex-col items-center justify-center min-h-screen text-center px-4 pt-32">
        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-fade-in mb-24">
          ...
          <h1 className="text-6xl md:text-7xl font-normal text-black mb-4 tracking-normal leading-none font-['Cormorant']">
            movement of real skills
          </h1>
          <p className="text-base text-gray-600 tracking-wider mb-4">M.O.R.S.</p>
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-12">
            <Link to="/learn-more">
              <Button 
                variant="outline" 
                className="text-black border-black hover:bg-black hover:text-white text-sm px-5 py-3 h-auto rounded-full transition-all"
              >
                learn more →
              </Button>
            </Link>
            <Link to="/get-involved">
              <Button 
                className="bg-black text-white hover:bg-gray-900 text-sm px-5 py-3 h-auto rounded-full transition-all"
              >
                get involved
              </Button>
            </Link>
