    ...
    <AccordionItem value="privacy-levels" className="border-white/10">
      ...
      <AccordionContent className="text-gray-400">
        <div className="space-y-6">
          <div>
            <h4 className="font-semibold mb-2 text-white/90">strictly private communications:</h4>
          ...
          <div>
            <h4 className="font-semibold mb-2 text-white/90">temporarily private communications:</h4>
            <ul className="list-disc list-inside space-y-1">
          ...
          <div>
            <h4 className="font-semibold mb-2 text-white/90">immediately public communications:</h4>
            <ul className="list-disc list-inside space-y-1">
