  ...
  return (
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-4">
        MORS was established to challenge the UK's outdated education system, which relies too heavily on standardized testing and memorization at the expense of developing practical, real-world skills.
      </p>
